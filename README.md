...
Ghost behavior is simplified. 
- Movement is guided by a grid of nodes positioned at each intersection. Ghost wont change path in the middle
...
- Ghosts departure from home is simplified. Every ghost has a pre-defined timer to leave home, which decreases with level progression.
...
- Flashing of the Ghosts is simplified (TODO: IMPLEMENT AND EXPLAIN WHY)
